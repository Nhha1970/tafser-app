...
Write-Host "Fetching Quran Uthmani for Surah Saba..."
...
$results | ConvertTo-Json -Depth 10 | Out-File -FilePath "saba_merged.json" -Encoding UTF8
Write-Host "Done! Saved to saba_merged.json - Count: $($results.Count)"
