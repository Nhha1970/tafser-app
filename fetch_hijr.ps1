...
Write-Host "Fetching Quran Uthmani for Surah Al-Hijr..."
...
$results | ConvertTo-Json -Depth 10 | Out-File -FilePath "hijr_merged.json" -Encoding UTF8
Write-Host "Done! Saved to hijr_merged.json - Count: $($results.Count)"
