...
Write-Host "Fetching Quran Uthmani for Surah Hud..."
...
$results | ConvertTo-Json -Depth 10 | Out-File -FilePath "hud_merged.json" -Encoding UTF8
Write-Host "Done! Saved to hud_merged.json - Count: $($results.Count)"
