...
Write-Host "Fetching Quran Uthmani for Surah An-Nahl..."
...
$results | ConvertTo-Json -Depth 10 | Out-File -FilePath "nahl_merged.json" -Encoding UTF8
Write-Host "Done! Saved to nahl_merged.json - Count: $($results.Count)"
