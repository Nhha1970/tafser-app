...
Write-Host "Fetching Quran Uthmani for Surah Ya-Sin..."
...
$results | ConvertTo-Json -Depth 10 | Out-File -FilePath "yasin_merged.json" -Encoding UTF8
Write-Host "Done! Saved to yasin_asin_merged.json - Count: $($results.Count)"
