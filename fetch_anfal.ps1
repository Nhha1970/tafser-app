...
Write-Host "Fetching Quran Uthmani for Surah Al-Anfal..."
...
$results | ConvertTo-Json -Depth 10 | Out-File -FilePath "anfal_merged.json" -Encoding UTF8
Write-Host "Done! Saved to anfal_merged.json - Count: $($results.Count)"
