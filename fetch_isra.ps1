...
Write-Host "Fetching Quran Uthmani for Surah Al-Isra..."
...
$results | ConvertTo-Json -Depth 10 | Out-File -FilePath "isra_merged.json" -Encoding UTF8
Write-Host "Done! Saved to isra_merged.json - Count: $($results.Count)"
