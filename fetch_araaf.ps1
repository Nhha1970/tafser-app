...
Write-Host "Fetching Quran Uthmani for Surah Al-A'raf..."
...
$results | ConvertTo-Json -Depth 10 | Out-File -FilePath "araaf_merged.json" -Encoding UTF8
Write-Host "Done! Saved to araaf_merged.json - Count: $($results.Count)"
