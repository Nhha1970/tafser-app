...
Write-Host "Fetching Quran Uthmani for Surah Taha..."
...
$results | ConvertTo-Json -Depth 10 | Out-File -FilePath "taha_merged.json" -Encoding UTF8
Write-Host "Done! Saved to taha_merged.json - Count: $($results.Count)"
