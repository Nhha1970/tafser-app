...
Write-Host "Fetching Quran Uthmani for Surah Al-An'am..."
...
$surahName = $quranResp.data.name # Fetching Arabic name from API to avoid encoding issues in script
...
$results | ConvertTo-Json -Depth 10 | Out-File -FilePath "anam_merged.json" -Encoding UTF8
Write-Host "Done! Saved to anam_merged.json - Count: $($results.Count)"
