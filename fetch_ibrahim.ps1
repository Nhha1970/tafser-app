...
Write-Host "Fetching Quran Uthmani for Surah Ibrahim..."
...
$results | ConvertTo-Json -Depth 10 | Out-File -FilePath "ibrahim_merged.json" -Encoding UTF8
Write-Host "Done! Saved to ibrahim_merged.json - Count: $($results.Count)"
