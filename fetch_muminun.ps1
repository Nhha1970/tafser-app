...
Write-Host "Fetching Quran Uthmani for Surah Al-Mu'minun..."
...
$results | ConvertTo-Json -Depth 10 | Out-File -FilePath "muminun_merged.json" -Encoding UTF8
Write-Host "Done! Saved to muminun_merged.json - Count: $($results.Count)"
