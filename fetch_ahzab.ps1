...
Write-Host "Fetching Quran Uthmani for Surah Al-Ahzab..."
...
$results | ConvertTo-Json -Depth 10 | Out-File -FilePath "ahzab_merged.json" -Encoding UTF8
Write-Host "Done! Saved to ahzab_merged.json - Count: $($results.Count)"
