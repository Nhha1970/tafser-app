...
Write-Host "Fetching Quran Uthmani for Surah Al-Furqan..."
...
$results | ConvertTo-Json -Depth 10 | Out-File -FilePath "furqan_merged.json" -Encoding UTF8
Write-Host "Done! Saved to furqan_merged.json - Count: $($results.Count)"
