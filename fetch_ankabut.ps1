...
Write-Host "Fetching Quran Uthmani for Surah Al-Ankabut..."
...
$results | ConvertTo-Json -Depth 10 | Out-File -FilePath "ankabut_merged.json" -Encoding UTF8
Write-Host "Done! Saved to ankabut_merged.json - Count: $($results.Count)"
