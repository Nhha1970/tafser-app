...
Write-Host "Fetching Quran Uthmani for Surah At-Tawbah..."
...
$results | ConvertTo-Json -Depth 10 | Out-File -FilePath "tawbah_merged.json" -Encoding UTF8
Write-Host "Done! Saved to tawbah_merged.json - Count: $($results.Count)"
