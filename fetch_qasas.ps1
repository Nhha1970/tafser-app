...
Write-Host "Fetching Quran Uthmani for Surah Al-Qasas..."
...
$results | ConvertTo-Json -Depth 10 | Out-File -FilePath "qasas_merged.json" -Encoding UTF8
Write-Host "Done! Saved to qasas_merged.json - Count: $($results.Count)"
