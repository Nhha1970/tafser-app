...
Write-Host "Fetching Quran Uthmani for Surah Ar-Ra'd..."
...
$results | ConvertTo-Json -Depth 10 | Out-File -FilePath "rad_merged.json" -Encoding UTF8
Write-Host "Done! Saved to rad_merged.json - Count: $($results.Count)"
