...
Write-Host "Fetching Quran Uthmani for Surah Yunus..."
...
$results | ConvertTo-Json -Depth 10 | Out-File -FilePath "yunus_merged.json" -Encoding UTF8
Write-Host "Done! Saved to yunus_merged.json - Count: $($results.Count)"
