...
Write-Host "Fetching Quran Uthmani for Surah Ar-Rum..."
...
$results | ConvertTo-Json -Depth 10 | Out-File -FilePath "rum_merged.json" -Encoding UTF8
Write-Host "Done! Saved to rum_merged.json - Count: $($results.Count)"
