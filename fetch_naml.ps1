...
Write-Host "Fetching Quran Uthmani for Surah An-Naml..."
...
$results | ConvertTo-Json -Depth 10 | Out-File -FilePath "naml_merged.json" -Encoding UTF8
Write-Host "Done! Saved to naml_merged.json - Count: $($results.Count)"
