...
Write-Host "Fetching Quran Uthmani for Surah Al-Anbiya..."
...
$results | ConvertTo-Json -Depth 10 | Out-File -FilePath "anbiya_merged.json" -Encoding UTF8
Write-Host "Done! Saved to anbiya_merged.json - Count: $($results.Count)"
