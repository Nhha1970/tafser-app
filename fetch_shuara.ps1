...
Write-Host "Fetching Quran Uthmani for Surah Ash-Shu'ara..."
...
$results | ConvertTo-Json -Depth 10 | Out-File -FilePath "shuara_merged.json" -Encoding UTF8
Write-Host "Done! Saved to shuara_merged.json - Count: $($results.Count)"
