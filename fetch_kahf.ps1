...
Write-Host "Fetching Quran Uthmani for Surah Al-Kahf..."
...
$results | ConvertTo-Json -Depth 10 | Out-File -FilePath "kahf_merged.json" -Encoding UTF8
Write-Host "Done! Saved to kahf_merged.json - Count: $($results.Count)"
