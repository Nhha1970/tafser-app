...
Write-Host "Fetching Quran Uthmani for Surah Sad..."
...
$results | ConvertTo-Json -Depth 10 | Out-File -FilePath "sad_merged.json" -Encoding UTF8
Write-Host "Done! Saved to sad_merged.json - Count: $($results.Count)"
