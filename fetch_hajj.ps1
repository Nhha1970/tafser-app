...
Write-Host "Fetching Quran Uthmani for Surah Al-Hajj..."
...
$results | ConvertTo-Json -Depth 10 | Out-File -FilePath "hajj_merged.json" -Encoding UTF8
Write-Host "Done! Saved to hajj_merged.json - Count: $($results.Count)"
