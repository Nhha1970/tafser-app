...
Write-Host "Fetching Quran Uthmani for Surah Luqman..."
...
$results | ConvertTo-Json -Depth 10 | Out-File -FilePath "luqman_merged.json" -Encoding UTF8
Write-Host "Done! Saved to luqman_merged.json - Count: $($results.Count)"
