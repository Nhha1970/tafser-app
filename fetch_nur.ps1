...
Write-Host "Fetching Quran Uthmani for Surah An-Nur..."
...
$results | ConvertTo-Json -Depth 10 | Out-File -FilePath "nur_merged.json" -Encoding UTF8
Write-Host "Done! Saved to nur_merged.json - Count: $($results.Count)"
