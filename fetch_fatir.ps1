...
Write-Host "Fetching Quran Uthmani for Surah Fatir..."
...
$results | ConvertTo-Json -Depth 10 | Out-File -FilePath "fatir_merged.json" -Encoding UTF8
Write-Host "Done! Saved to fatir_merged.json - Count: $($results.Count)"
