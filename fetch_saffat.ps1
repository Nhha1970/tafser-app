...
Write-Host "Fetching Quran Uthmani for Surah As-Saffat..."
...
$results | ConvertTo-Json -Depth 10 | Out-File -FilePath "saffat_merged.json" -Encoding UTF8
Write-Host "Done! Saved to saffat_merged.json - Count: $($results.Count)"
