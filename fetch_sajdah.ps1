...
Write-Host "Fetching Quran Uthmani for Surah As-Sajdah..."
...
$results | ConvertTo-Json -Depth 10 | Out-File -FilePath "sajdah_merged.json" -Encoding UTF8
Write-Host "Done! Saved to sajdah_merged.json - Count: $($results.Count)"
