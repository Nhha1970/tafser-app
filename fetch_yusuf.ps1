...
Write-Host "Fetching Quran Uthmani for Surah Yusuf..."
...
$results | ConvertTo-Json -Depth 10 | Out-File -FilePath "yusuf_merged.json" -Encoding UTF8
Write-Host "Done! Saved to yusuf_merged.json - Count: $($results.Count)"
